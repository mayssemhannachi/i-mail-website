/*
  ...
  - You are about to drop the column `emailAdress` on the `Account` table. All the data in the column will be lost.
...
DROP COLUMN "emailAdress",
ADD COLUMN     "binaryIndex" JSONB,
